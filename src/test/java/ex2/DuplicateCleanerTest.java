...
import static ex2.Cleaner.removeDuplicates;
...
class DuplicateCleanerTest {
  ...
  void shouldRemoveDuplicate() {
    ...
    assertThat(removeDuplicates(text)).isEqualTo("What is my purpose?");
  }
  ...
  void shouldRemoveDuplicatesAtTheEnd() {
    ...
    assertThat(removeDuplicates(text)).isEqualTo("Yeah, welcome to the club, pal.");
  }
